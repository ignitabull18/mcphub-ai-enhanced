...
const MarketPage: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 md:mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 flex flex-col sm:flex-row sm:items-center">
            ...
            <span className="text-xs sm:text-sm text-gray-500 font-normal sm:ml-2 mt-1 sm:mt-0">{t('pages.market.title').split(' - ')[1]}</span>
          </h1>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-4 sm:p-6 mb-4 sm:mb-6 page-card">
        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2 sm:gap-4 mb-0">
          <div className="flex-grow">
            <input
              ...
              className="shadow appearance-none border border-gray-200 rounded w-full py-2 px-3 text-sm sm:text-base text-gray-700 leading-tight focus:outline-none focus:shadow-outline form-input"
            />
          </div>
          <div className="flex gap-2">
            <button
              type="submit"
              className="px-3 py-2 sm:px-4 bg-blue-100 text-blue-800 rounded hover:bg-blue-200 flex items-center btn-primary transition-all duration-200 text-sm sm:text-base"
            >
              {t('market.search')}
            </button>
            {(searchQuery || selectedCategory || selectedTag) && (
              <button
                ...
                className="border border-gray-300 text-gray-700 font-medium py-2 px-3 sm:px-4 rounded hover:bg-gray-50 btn-secondary transition-all duration-200 text-sm sm:text-base"
              >
