...
} from '../controllers/smartGroupController.js';
...
export const initRoutes = (app: express.Application): void => {
  ...
  // Smart Group Creation routes
  router.post('/smart-groups/conversation', startConversation);
  router.post('/smart-groups/conversation/:conversationId', sendMessage);
  router.get('/smart-groups/conversation/:conversationId', getConversation);
  router.get('/smart-groups/conversations', listConversations);
  router.delete('/smart-groups/conversation/:conversationId', deleteConversation);
  router.get('/smart-groups/tool-analysis', getToolAnalysis);
  router.post('/smart-groups/proposals', generateProposals);
  router.post('/smart-groups/cleanup', cleanupConversations);
