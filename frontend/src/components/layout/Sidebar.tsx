...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, mobileMenuOpen, onCloseMobileMenu }) => {
  ...
  return (
    <aside
      className={`
        bg-white dark:bg-gray-800 shadow-sm transition-all duration-300 ease-in-out flex flex-col h-full
        ${collapsed ? 'w-16' : 'w-64'}
        ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}
        md:translate-x-0 fixed md:relative left-0 top-0 z-50 md:z-0
      `}
    >
