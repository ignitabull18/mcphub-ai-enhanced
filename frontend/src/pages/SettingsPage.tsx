...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 md:mb-8">{t('pages.settings.title')}</h1>

      {/* Smart Routing Configuration Settings */}
      <PermissionChecker permissions={PERMISSIONS.SETTINGS_SMART_ROUTING}>
        <div className="bg-white shadow rounded-lg py-4 px-4 sm:px-6 mb-4 sm:mb-6 page-card">
          <div
          ...
          >
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">{t('pages.settings.smartRouting')}</h2>
      ...
      <div className="bg-white shadow rounded-lg py-4 px-4 sm:px-6 mb-4 sm:mb-6">
        <div
          className="flex justify-between items-center cursor-pointer"
          onClick={() => toggleSection('routingConfig')}
        >
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">{t('pages.settings.routeConfig')}</h2>
      ...
      <PermissionChecker permissions={PERMISSIONS.SETTINGS_INSTALL_CONFIG}>
        <div className="bg-white shadow rounded-lg py-4 px-4 sm:px-6 mb-4 sm:mb-6">
          ...
          >
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">{t('settings.installConfig')}</h2>
            <span className="text-gray-500">
      ...
      <div className="bg-white shadow rounded-lg py-4 px-4 sm:px-6 mb-4 sm:mb-6">
        ...
        >
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">{t('auth.changePassword')}</h2>
          <span className="text-gray-500">
