...
const ServerForm = ({ onSubmit, onCancel, initialData = null, modalTitle, formError = null }: ServerFormProps) => {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-4 sm:p-6 w-full max-w-xl max-h-[90vh] overflow-y-auto">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900">{modalTitle}</h2>
    ...
    ...
        ...
        {serverType !== 'openapi' && (
          <div className="mb-4">
            ...
            {isRequestOptionsExpanded && (
              <div className="border border-gray-200 rounded-b p-3 sm:p-4 bg-gray-50 border-t-0">
